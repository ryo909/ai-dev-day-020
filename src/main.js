import './style.css';
const PROFILE = {"day":"Day020","title":"Dependency Flow Board","one_sentence":"依存関係を崩さず着手順を整理するフローボード。（話題:GitHub Trending (A）","core_action":"sequence","family":"dependency_board","mechanic":"constrained_lane_movement","input_style":"card_creation","output_style":"lane_board","audience_promise":"fewer_rework_cycles","publish_hook":"依存関係を守って流せるボード","engine":"flow_board","interaction_archetype":"board_flow_builder","page_archetype":"kanban_board","output_shape":"lane_columns","state_model":"cards_by_lane","core_loop":"add dependency -> move only ready cards","component_pack":"lane_columns+dependency_lock","scaffold_id":"flow_board","single_shot_text_generator":false};
